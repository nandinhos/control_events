    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navbar class="-mb-px max-lg:hidden">
                ...
                <flux:navbar.item icon="users" href="{{ route('entidades.index') }}" :current="request()->routeIs('entidades.index')" wire:navigate>
                    Entidades
                </flux:navbar.item>
            </flux:navbar>
        ...
        <flux:sidebar stashable sticky class="lg:hidden border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.group heading="Operações" class="grid gap-0.5">
                    <flux:navlist.item icon="document" :href="route('contracts')" :current="request()->routeIs('contracts')" wire:navigate>Contratos</flux:navlist.item>
                ...
                <flux:navlist.group heading="Financeiro" class="grid gap-0.5">
                    ...
                    <flux:navlist.item icon="arrows-right-left" :href="route('conciliacao')" :current="request()->routeIs('conciliacao')" wire:navigate>Conciliação</flux:navlist.item>
                </flux:navlist.group>

                <flux:navlist.group heading="Configurações" class="grid gap-0.5">
                    <flux:navlist.item icon="users" :href="route('entidades.index')" :current="request()->routeIs('entidades.index')" wire:navigate>Entidades</flux:navlist.item>
            ...
            <flux:navlist variant="outline">
                <flux:navlist.item icon="bookmark" href="https://github.com/laravel/livewire-starter-kit" target="_blank">
                    Repository
                </flux:navlist.item>
